...
parser.add_argument("--excludes", type=str, help="directory to exclude; exclude=tests,examples", default=DEFAULT_EXCLUDE_DIRECTORIES)
parser.add_argument("--types", type=str, help="allowed file types; types=*.json,README.md", default=DEFAULT_INCLUDE_FILE_TYPES)
